...
st.markdown("<h1 style='text-align: center; color: blue; background-color: yellow;'>Cricket Analyze</h1>", unsafe_allow_html=True)
...
if menu == 'Live Score':
    ...
    url = "https://www.cricbuzz.com/live-cricket-scores/60042/ind-vs-aus-3rd-odi-australia-tour-of-india-2023"
